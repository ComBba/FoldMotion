...
- 강도 조절과 햅틱 온/오프
- 최근 앱에서 쓸어도 알림의 상주 서비스가 효과를 유지합니다. 알림에서 바로 끌 수 있습니다.
...
The overlay is touch-through. Choose Fluid, Hinge Shadow, Fade, or Haptic, then set strength. A persistent notification keeps the effect available after you leave the app, and you can turn it off from that notification.
